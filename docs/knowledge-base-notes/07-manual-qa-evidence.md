...
| Commit under test | `3bb118d6` |
| Tester | Codex automated baseline |
| Test date | 2026-06-15 |
| `pnpm acceptance:knowledge` result | Pass on 2026-06-15 for commit `3bb118d6`: 33 core test files / 487 tests, core TS, desktop TS, desktop production bundle, mobile TS, generated WebView bundle, workspace/chat/editor contract checks including persistent proposal-apply failure states with localized conflict reasons, grouped custom-card field sections, and AI tool write-safety status, and whitespace check passed. |
...
| --- | --- | --- | --- |
| Clean branch | Worktree is clean and pushed before manual QA starts. | Pass | Runtime commit `3bb118d6` was tested by the automated gate; this manual evidence refresh is docs-only and should be pushed before manual QA starts. |
| Full automated gate | `pnpm acceptance:knowledge` passes. | Pass | Passed on 2026-06-15 for commit `3bb118d6`: 33 core test files / 487 tests plus core TS, desktop TS, desktop production bundle, mobile TS, WebView bundle, contract checks including persistent proposal-apply failure states with localized conflict reasons, grouped custom-card field sections, and AI tool write-safety status, and whitespace check. |
