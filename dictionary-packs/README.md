...
`manifest.json` are planned locations only until the `dictionary-packs-v1`
GitHub release and both assets are actually published.
...
```powershell
pnpm --filter @readany/cli dictionary:convert-wordnet -- --input-directory D:\dev\_artifacts\readany-dictionary-source\wordnet-3.1\dict --output D:\dev\_artifacts\readany-dictionary-source\en-wordnet-3.1.jsonl

pnpm --filter @readany/cli dictionary:build -- --language en --input D:\dev\_artifacts\readany-dictionary-source\en-wordnet-3.1.jsonl --output D:\dev\_artifacts\readany-dictionary-source\readany-dictionary-en-v1.sqlite --version 1.0.0 --source-edition wordnet-3.1 --license "WordNet 3.1 License" --source-date 2011-05-26 --source-archive-url https://wordnetcode.princeton.edu/wn3.1.dict.tar.gz --attribution-url https://wordnet.princeton.edu/license-and-commercial-use --license-file D:\dev\ReadAny-offline-dictionary-worktree\dictionary-packs\LICENSE-WORDNET-3.1.txt --creator-attribution "WordNet 3.1 Copyright 2011 by Princeton University. All rights reserved." --asset-url https://github.com/cha1latte/ReadAny/releases/download/dictionary-packs-v1/readany-dictionary-en-v1.sqlite --descriptor D:\dev\_artifacts\readany-dictionary-source\en-descriptor.json

pnpm --filter @readany/cli dictionary:build -- --language zh --input D:\dev\_artifacts\readany-dictionary-source\zh-20260901.jsonl --output D:\dev\_artifacts\readany-dictionary-source\readany-dictionary-zh-v1.sqlite --version 1.0.0 --source-edition zhwiktionary --license "CC BY-SA 4.0" --source-date 2026-09-01 --source-archive-url https://dumps.wikimedia.org/zhwiktionary/20260901/zhwiktionary-20260901-pages-articles.xml.bz2 --attribution-url https://zh.wiktionary.org/wiki/Wiktionary:%E7%89%88%E6%9D%83%E4%BF%A1%E6%81%AF --license-file D:\dev\ReadAny-offline-dictionary-worktree\dictionary-packs\LICENSE-WIKTIONARY.txt --creator-attribution "Wiktionary contributors." --asset-url https://github.com/cha1latte/ReadAny/releases/download/dictionary-packs-v1/readany-dictionary-zh-v1.sqlite --descriptor D:\dev\_artifacts\readany-dictionary-source\zh-descriptor.json
```
