...
export const makeStyles = (colors: ThemeColors) =>
  StyleSheet.create({
    ...
    knowledgeDocumentStripContent: { gap: 8, paddingRight: 2 },
    ...
    knowledgeDocumentChipActive: {
      borderColor: withOpacity(colors.primary, 0.35),
      backgroundColor: withOpacity(colors.primary, 0.1),
    },
    knowledgeDocumentChipTitle: {
      fontSize: fontSize.xs,
      color: colors.foreground,
      fontWeight: fontWeight.semibold,
      lineHeight: 17,
    },
    knowledgeDocumentChipTitleActive: { color: colors.primary },
    knowledgeDocumentChipMeta: {
      marginTop: 2,
      fontSize: 11,
      color: colors.mutedForeground,
      lineHeight: 14,
