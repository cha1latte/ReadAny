...
export const makeStyles = (colors: ThemeColors) =>
  StyleSheet.create({
    ...
    knowledgeVaultText: { flex: 1, minWidth: 0 },
    ...
    knowledgeWorkspaceTabActive: {
      borderColor: withOpacity(colors.primary, 0.24),
      backgroundColor: withOpacity(colors.primary, 0.09),
    },
    knowledgeWorkspaceTabDisabled: {
      opacity: 0.48,
    },
    knowledgeWorkspaceTabText: {
      fontSize: fontSize.xs,
      lineHeight: 16,
      color: colors.mutedForeground,
      fontWeight: fontWeight.medium,
    },
    knowledgeWorkspaceTabTextActive: {
      color: colors.primary,
      fontWeight: fontWeight.semibold,
    },
    knowledgeVaultFocusCard: {
      minHeight: 72,
      flexDirection: "row",
      alignItems: "center",
      gap: 10,
    ...
    knowledgeVaultFocusPath: {
      marginTop: 3,
      fontSize: 11,
      lineHeight: 15,
      color: colors.mutedForeground,
    },
    knowledgeVaultFocusButton: {
      minHeight: 34,
      flexDirection: "row",
      alignItems: "center",
      gap: 4,
